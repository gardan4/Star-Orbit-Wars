...
# Built by tools/bundle.py on 2026-04-30 16:28:22.
# Bot: mcts_bot
#
...
# --- NN prior bootstrap (--nn-dataset-path /kaggle/input/orbit-wars-az-v39-bigger/az_v39_bigger.pt) ---
import torch as _bundle_torch
_BUNDLE_BC_CKPT_PATH = '/kaggle/input/orbit-wars-az-v39-bigger/az_v39_bigger.pt'
...
_bundle_cfg.total_sims = 16

_bundle_cfg.num_candidates = 4

_bundle_cfg.hard_deadline_ms = 300.0
