...
# Built by tools/bundle.py on 2026-04-22 14:14:45.
# Bot: mcts_bot
#
...
def _rollout_value(
    ...
    my_player: int,
    my_action: List[List],
    opp_agent_factory: Callable[[], HeuristicAgent],
    my_future_factory: Callable[[], HeuristicAgent],
    depth: int,
    num_agents: int = 2,
